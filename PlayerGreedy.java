 ...
 * @author Lucas
 */
public class PlayerGreedy extends AbstractPlayer{

    public PlayerGreedy(int depth) {
        super(depth);
    }
    ...
    public float evaluateState(int[][] tab, Casa casa){
        ...
        soma_heuristicas+= heuristicaPosicional(tab) * 1 ;         //heuristica1
        soma_heuristicas+= heuristicaMobilidade(tab) * 1 ;         //heuristica2
        soma_heuristicas+= heuristicaPecasVantagem(tab) * 1 ;      //heuristica3
        soma_heuristicas+= heuristicaEstabilidade(tab) * 1 ;       //heuristica4
        soma_heuristicas+= heuristicaWinLose(tab) * 1 ;            //heuristica5
    ...
    public Casa jogar(int[][] tab) {
        ...
        for(int i=0;i<jogadas.size();i++){
            ...
            valor_jogada[i]=evaluateState(temp, jogadas.get(i).getCasa());      //calcula as heuristicas
        }
        int maior_indice=0;
        for(int i=1;i<jogadas.size();i++){
            if(valor_jogada[maior_indice]<valor_jogada[i]){
                maior_indice=i;
            }
        }
        try {
    ...
    public boolean especialistaPreparaTomarCantos(int[][] tab, Casa casa){ //Especialista 3
        if (casa==null){
            return false;
        }
    ...
    public boolean especialistaTaticaTomarCantos(int[][] tab, Casa casa){ //Especialista 2
        if (casa==null){
            return false;
        }
        ...
        public boolean especialistaCantos(int[][] tab, Casa casa){ //Especialista 1
        if(
